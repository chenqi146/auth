...
public class Resource extends BaseEntity {
    ...
    @Column(columnDefinition = "varchar(256) DEFAULT '' COMMENT '资源名称'")
    private String name;

    @Column(nullable = false, columnDefinition = "varchar(512) DEFAULT '' COMMENT '资源url'")
    private String url;

    @Column(columnDefinition = "varchar(256) DEFAULT '' COMMENT '资源描述'")
